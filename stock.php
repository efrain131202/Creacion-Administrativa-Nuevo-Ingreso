<?php
	...
	$title="Creacion Administrativa Nuevo Ingreso";
?>
<!DOCTYPE html>
<html lang="en">
  <head>
  ...
  <body>
	...
	<div class="panel panel-success">
		<div class="panel-heading">
			...
			<h4><i class='glyphicon glyphicon-search'></i> Consultar Alumnos</h4>
		</div>
		<div class="panel-body">
			...
			<form class="form-horizontal" role="form" id="datos">
				...
				<div class="row">
					<div class='col-md-4'>
						<label>Filtrar por Matricula o nombre</label>
						<input type="text" class="form-control" id="q" placeholder="Matricula o nombre del Alumno" onkeyup='load(1);'>
					</div>
