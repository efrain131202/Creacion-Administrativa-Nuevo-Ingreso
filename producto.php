<?php
	...
	$active_clientes="";
	$active_usuarios="";	
	$title="Instituto de Enseñanza e Investigación Nuevo Milenio";
          ...
          <div class="panel-body">
            <div class="row">
              <div class="col-sm-4 col-sm-offset-2 text-center">
				 <img class="item-img img-responsive" src="img/alumno.png" alt=""> 
				  <br>
              ...
              <div class="col-sm-4 text-left">
                <div class="row margin-btm-20">
                    ...
                    <div class="col-sm-6 col-xs-6 col-md-4 ">
                      <a href="" data-toggle="modal" data-target="#add-stock"><img width="100px"  src="img/agregar+.png"></a>
                    </div>
                    <div class="col-sm-6 col-xs-6 col-md-4">
                      <a href="" data-toggle="modal" data-target="#remove-stock"><img width="100px"  src="img/quitar.png"></a>
                    </div>
                    <div class="col-sm-12 margin-btm-10">
                    </div>
                  ...
                  <div class="row">
					...
					?>	
					 <table class='table table-bordered'>
						<tr>
							<th class='text-center' colspan=5 >HISTORIAL DE ALUMNO</th>
						</tr>
						<tr>
							<td>Fecha</td>
							<td>Hora</td>
